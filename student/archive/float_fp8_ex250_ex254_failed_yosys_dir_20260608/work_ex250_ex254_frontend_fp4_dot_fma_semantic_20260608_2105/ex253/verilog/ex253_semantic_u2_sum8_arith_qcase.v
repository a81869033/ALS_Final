module ex253_semantic_u2_sum8_arith_qcase(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [5:0] lane_sum = {4'd0, in[1:0]} + {4'd0, in[3:2]} + {4'd0, in[5:4]} + {4'd0, in[7:6]} + {4'd0, in[9:8]} + {4'd0, in[11:10]} + {4'd0, in[13:12]} + {4'd0, in[15:14]};
