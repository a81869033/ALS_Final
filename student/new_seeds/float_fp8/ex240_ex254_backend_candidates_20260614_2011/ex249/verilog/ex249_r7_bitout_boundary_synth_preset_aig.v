module ex249_r7_bitout_boundary(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [6:0] a = in[14:8];
  wire [6:0] b = in[6:0];
  ...
  wire [1:0] delta = active_gap ? delta_raw : 2'd0;
  wire sat = (maxc == 7'h7e) || ((maxc == 7'h7d) && delta[1]);
  wire [6:0] sum_mag = maxc + {5'd0, delta};
  wire [6:0] mag = sat ? 7'h7e : sum_mag;
  assign out[7] = 1'b0;
  assign out[6:0] = nan ? 7'h7f : mag;
endmodule
