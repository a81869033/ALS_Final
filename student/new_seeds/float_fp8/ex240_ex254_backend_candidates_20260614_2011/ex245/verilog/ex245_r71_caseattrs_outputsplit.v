module ex245_r71_caseattrs_outputsplit(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [7:0] a = in[15:8];
  wire [7:0] b = in[7:0];
  ...
  function [6:0] same_class_mag;
    ...
    input [5:0] base_eff;
    begin
      (* full_case, parallel_case *) case (key)
        8'h00: begin
  ...
  wire [6:0] out_mag = use_same_table ? same_mag_tbl : (use_diff_table ? diff_mag_tbl : maxc);
  wire diff_sign = (maxc == minc) ? 1'b0 : max_sign;
  wire out_sign = same_sign ? a[7] : diff_sign;
  assign out[7] = nan ? 1'b0 : out_sign;
