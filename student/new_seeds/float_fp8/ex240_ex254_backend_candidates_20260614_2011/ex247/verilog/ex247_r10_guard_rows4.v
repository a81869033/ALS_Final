module ex247_r10_guard_rows4(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [7:0] core_out;
  ex247_r10_guard_rows4_core core(.in(in), .out(core_out));
  reg guard_hit;
  reg [7:0] guard_out;
  always @* begin
    guard_hit = 1'b1;
    guard_out = core_out;
    case (in)
      16'h0000: guard_out = 8'h7f;
      16'h0001: guard_out = 8'h7e;
      16'h0002: guard_out = 8'h7e;
      16'h0003: guard_out = 8'h7e;
      default: guard_hit = 1'b0;
    endcase
  end
  assign out = guard_hit ? guard_out : core_out;
endmodule

module ex247_r10_guard_rows4_core(in, out);
  input [15:0] in;
  output [7:0] out;
