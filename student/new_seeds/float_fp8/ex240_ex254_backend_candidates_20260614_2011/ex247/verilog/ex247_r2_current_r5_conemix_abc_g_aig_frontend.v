module ex247_r2_current_r5_conemix_abc_g_aig_frontend_current(in, out);
  input [15:0] in;
  output [7:0] out;
...
module ex247_r2_current_r5_conemix_abc_g_aig_frontend_alt(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [7:0] den = in[15:8];
  wire [7:0] num = in[7:0];
  ...
  always @* begin
    case ({low_step, pat})
      4'b0000: low_bits = 3'b011;
      4'b0001: low_bits = 3'b011;
      4'b0010: low_bits = 3'b011;
      4'b0011: low_bits = 3'b011;
      4'b0100: low_bits = 3'b001;
      4'b0101: low_bits = 3'b001;
      4'b0110: low_bits = 3'b001;
      4'b0111: low_bits = 3'b001;
      4'b1000: low_bits = 3'b010;
      4'b1001: low_bits = 3'b001;
      4'b1010: low_bits = 3'b001;
      4'b1011: low_bits = 3'b010;
      4'b1100: low_bits = 3'b100;
      4'b1101: low_bits = 3'b010;
      4'b1110: low_bits = 3'b011;
      default: low_bits = 3'b011;
    endcase
  end
  wire low_b2 = low_bits[2];
  wire low_b1 = low_bits[1];
  wire low_b0 = low_bits[0];
  wire [6:0] low_mag = {4'b0000, low_bits};
  wire [6:0] linear_mag = {out_exp_s[4:0], mant};
  reg [6:0] mag;
  always @* begin
    casez ({den_zero, zero_region, sat_region, low_region})
...
module ex247_r2_current_r5_conemix_abc_g_aig_frontend(in, out);
  input [15:0] in;
  output [7:0] out;
  wire [7:0] current_out;
  wire [7:0] alt_out;
  ex247_r2_current_r5_conemix_abc_g_aig_frontend_current u_current(.in(in), .out(current_out));
  ex247_r2_current_r5_conemix_abc_g_aig_frontend_alt u_alt(.in(in), .out(alt_out));
  assign out = {current_out[7:3], alt_out[2:0]};
endmodule
