module ex247_r2_lowpred_step_mux_abc_g_aig_frontend(in, out);
  input [15:0] in;
  output [7:0] out;
  ...
  wire [2:0] low_bits_s2 = {1'b0, (pat0 || pat3), (pat1 || pat2)};
  wire [2:0] low_bits_s3 = {pat0, !pat0, pat[1]};
  wire [2:0] low_bits = low_step[1] ? (low_step[0] ? low_bits_s3 : low_bits_s2) :
                                       (low_step[0] ? 3'b001 : 3'b011);
