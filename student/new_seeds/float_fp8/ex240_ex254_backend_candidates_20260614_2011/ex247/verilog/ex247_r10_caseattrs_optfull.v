module ex247_r10_caseattrs_optfull(in, out);
  input [15:0] in;
  output [7:0] out;
  ...
  function [8:0] bound_tail;
    ...
    input [2:0] sig_d;
    begin
      (* parallel_case *) case (sig_d)
        3'd1: begin
          (* parallel_case *) case (sig_n)
  ...
  reg [2:0] low_bits;
  always @* begin
    (* parallel_case *) case ({low_step, pat})
  ...
  reg [6:0] mag;
  always @* begin
    (* parallel_case *) casez ({den_zero, zero_region, sat_region, low_region})
      4'b1???: mag = 7'h7e;
      4'b01??: mag = 7'h00;
      4'b001?: mag = 7'h7e;
      4'b0001: mag = low_mag;
