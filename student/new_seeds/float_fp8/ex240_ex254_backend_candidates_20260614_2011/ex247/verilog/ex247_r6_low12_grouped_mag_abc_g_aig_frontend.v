module ex247_r6_low12_grouped_mag_abc_g_aig_frontend(in, out);
  input [15:0] in;
  output [7:0] out;
  ...
  wire use_linear_mag = !(zero_region || sat_region || low_region);
  wire [6:0] mag;
  reg [4:0] mag_hi;
  always @* begin
    casez ({den_zero, zero_region, sat_region, low_region})
      4'b1???: mag_hi = 5'b11111;
      4'b01??: mag_hi = 5'b00000;
      4'b001?: mag_hi = 5'b11111;
      4'b0001: mag_hi = {4'b0000, low_b2};
      default: mag_hi = linear_mag[6:2];
    endcase
  end
  assign mag[6:2] = mag_hi;
  assign mag[1] = sat_region || (low_region && low_b1) || (use_linear_mag && linear_mag[1]);
  assign mag[0] = (low_region && low_b0) || (use_linear_mag && linear_mag[0]);
