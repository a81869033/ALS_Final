...
module ex285_r7_boundary_mid_quad(in, out);
  input [11:0] in;
  output [11:0] out;
  wire [11:0] base_out;
  ex285_uc_boundary_alt_0_2_9_11_base_ex285_unknown_12x12_decision_tree_greedy u_base(.in(in), .out(base_out));
  wire [11:0] donor0_out;
  ex285_uc_boundary_alt_0_2_9_11_boundary_ex285_r77_tree_route_decode_helper_boundary u_donor0(.in(in), .out(donor0_out));
  assign out[0] = base_out[0];
  assign out[1] = base_out[1];
  assign out[2] = base_out[2];
  assign out[3] = base_out[3];
  assign out[4] = donor0_out[4];
  assign out[5] = donor0_out[5];
  assign out[6] = donor0_out[6];
  assign out[7] = donor0_out[7];
  assign out[8] = base_out[8];
