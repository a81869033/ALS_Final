...
module ex285_r9_boundary_mask_all_boundary_optfull(in, out);
  input [11:0] in;
  output [11:0] out;
  wire [11:0] base_out;
  ...
  assign out[1] = boundary_out[1];
  assign out[2] = boundary_out[2];
  assign out[3] = boundary_out[3];
  assign out[4] = boundary_out[4];
  assign out[5] = boundary_out[5];
  assign out[6] = boundary_out[6];
  assign out[7] = boundary_out[7];
  assign out[8] = boundary_out[8];
  assign out[9] = boundary_out[9];
  assign out[10] = boundary_out[10];
