module ex204_r95_bf16_log2_direct_log2_arithbase_delta_hilo3_bits_11_bh2(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  assign out = {(sign ? pair[31] : pair[15]), (sign ? pair[30] : pair[14]), (sign ? pair[29] : pair[13]), (sign ? pair[28] : pair[12]), bit_11, (sign ? pair[26] : pair[10]), (sign ? pair[25] : pair[9]), (sign ? pair[24] : pair[8]), (sign ? pair[23] : pair[7]), (sign ? pair[22] : pair[6]), (sign ? pair[21] : pair[5]), (sign ? pair[20] : pair[4]), (sign ? pair[19] : pair[3]), (sign ? pair[18] : pair[2]), (sign ? pair[17] : pair[1]), (sign ? pair[16] : pair[0])};
endmodule
