module ex208_bf16_sinh_r94_default_in_const_excepts_h4_manual_bits_15(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  always @* begin
    manual_bit_15 = 1'b0;
    casez (sign_exp)
      9'b10???????: manual_bit_15 = 1'b1;
      9'b110??????: manual_bit_15 = 1'b1;
      9'b1110?????: manual_bit_15 = 1'b1;
      9'b11110????: manual_bit_15 = 1'b1;
      9'b111110???: manual_bit_15 = 1'b1;
      9'b1111110??: manual_bit_15 = 1'b1;
      9'b11111110?: manual_bit_15 = 1'b1;
      9'b111111110: manual_bit_15 = 1'b1;
        9'h1ff: begin
          case (mant_hi4)
            4'h0: begin
              manual_bit_15 = 1'b0;
              case (mant_lo3)
                3'h0: manual_bit_15 = 1'b1;
                default: begin end
              endcase
            end
            4'h1: begin
  ...
  assign out = {manual_bit_15, out_r[14:0]};
endmodule
