module ex205_r95_bf16_log10_transform_source_reuse_out_sign(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  assign out = {out_sign, out_exp[7], out_exp[6], out_exp[5], out_exp[4], out_exp[3], out_exp[2], out_exp[1], out_exp[0], out_mant[6], out_mant[5], out_mant[4], out_mant[3], out_mant[2], out_mant[1], out_mant[0]};
endmodule
