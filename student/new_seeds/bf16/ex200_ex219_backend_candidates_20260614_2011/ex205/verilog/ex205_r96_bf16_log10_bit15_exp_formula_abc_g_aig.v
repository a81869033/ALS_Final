module ex205_r96_bf16_log10_bit15_exp_formula(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  wire input_sign = sign_exp[8];
  wire [7:0] input_exp = sign_exp[7:0];
  wire bit_15 = ((!input_sign) && (input_exp <= 8'h7e)) ||
                (input_sign && (input_exp == 8'h00));
  assign out = {bit_15, out_exp[7], out_exp[6], out_exp[5], out_exp[4], out_exp[3], out_exp[2], out_exp[1], out_exp[0], out_mant[6], out_mant[5], out_mant[4], out_mant[3], out_mant[2], out_mant[1], out_mant[0]};
endmodule
