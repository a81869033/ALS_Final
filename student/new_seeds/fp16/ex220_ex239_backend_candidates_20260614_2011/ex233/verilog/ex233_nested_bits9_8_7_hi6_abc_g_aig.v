module ex233_nested_bits9_8_7_hi6(in, out);
  input [15:0] in;
  output [15:0] out;
  wire sign = in[15];
  ...
  always @* begin
    case (cls)
      ...
      1'h1: begin
        if (mant <= 10'h23e) begin
          mant_b8 = 0;
        end else begin
          mant_b8 = 1;
        end
      end
      default: mant_b8 = 1'b0;
    endcase
  end
  reg mant_b7;
  always @* begin
    case (cls)
      ...
      1'h1: begin
        if (mant <= 10'h23e) begin
          if (mant <= 10'h10e) begin
            mant_b7 = 0;
          end else begin
            mant_b7 = 1;
          end
        end else begin
          if (mant <= 10'h38e) begin
            mant_b7 = 0;
          end else begin
            mant_b7 = 1;
          end
