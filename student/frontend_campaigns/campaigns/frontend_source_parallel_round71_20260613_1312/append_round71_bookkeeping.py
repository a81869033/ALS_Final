#!/usr/bin/env python3
"""Append round71 nonwinning attempts to campaign bookkeeping CSVs."""
...
RUN_ID = "frontend_source_parallel_round71_20260613_1312"
...
def main():
    ...
    for row in candidates:
        ...
        source = "{0}/{1}".format(RUN_ID, row.get("agent_id", "coordinator-round71"))
