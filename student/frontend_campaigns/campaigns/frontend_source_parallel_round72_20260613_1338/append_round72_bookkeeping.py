...
def main():
    ...
    for row in candidates:
        ...
        source = "{}/{}".format(RUN_ID, row.get("agent_id", "coordinator-round72"))
        ...
        hyp_add.append(
            {
                ...
                "reason": "official OK ADP {} did not beat current frontend/reference".format(row.get("adp", "")),
                "created_by": row.get("agent_id") or "coordinator-round72",
                "created_at": DATE,
            }
        )
