#!/usr/bin/env python3
"""Merge round23 frontend campaign shard CSVs."""
...
RUN_ID = "ex200_ex299_frontend_refgap_round23_20260613_0317"

spec = importlib.util.spec_from_file_location("round23_merge_base", str(TEMPLATE))
merge = importlib.util.module_from_spec(spec)
spec.loader.exec_module(merge)

merge.RUN_ID = RUN_ID
merge.ROUND_LABEL = "round23"
merge.HERE = HERE
merge.ROOT = ROOT
...
merge.base.read_rows = read_rows_round23
