# ex286_ex289_frontend_output_linear_anf_diag_20260609_1854

Run ID: `ex286_ex289_frontend_output_linear_anf_diag_20260609_1854`
...
Artifacts:
- Work directory: `student/work/ex286_ex289_frontend_output_linear_anf_diag_20260609_1854`
- Results directory: `student/runs/unknown/ex286_ex289_frontend_output_linear_anf_diag_20260609_1854/results`
- Results: `results/summary.csv`, `results/basis.csv`

Methods tried:
- Word-level Mobius transform of the multi-output truth table.
- Nullspace of all output coefficient vectors above each target degree `1,2,3,4`.
