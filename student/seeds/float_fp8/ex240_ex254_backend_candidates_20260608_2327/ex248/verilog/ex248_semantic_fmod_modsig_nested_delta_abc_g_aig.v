module ex248_semantic_fmod_modsig_nested_delta(in, out);
  input [15:0] in;
  output [7:0] out;
  ...
  function [2:0] rem_table;
    ...
    begin
      ...
      case (delta_key)
        5'd0: begin
          case (sig_key)
          6'h0a: rem_table = 3'd1;
          6'h0b: rem_table = 3'd1;
          6'h0c: rem_table = 3'd1;
          6'h0d: rem_table = 3'd1;
          6'h0e: rem_table = 3'd1;
          6'h0f: rem_table = 3'd1;
          6'h13: rem_table = 3'd2;
          6'h14: rem_table = 3'd2;
          6'h15: rem_table = 3'd2;
          6'h16: rem_table = 3'd2;
          6'h17: rem_table = 3'd2;
          6'h1a: rem_table = 3'd1;
          6'h1c: rem_table = 3'd3;
          6'h1d: rem_table = 3'd3;
          6'h1e: rem_table = 3'd3;
          6'h1f: rem_table = 3'd3;
          6'h23: rem_table = 3'd1;
          6'h25: rem_table = 3'd4;
          6'h26: rem_table = 3'd4;
          6'h27: rem_table = 3'd4;
          6'h2a: rem_table = 3'd1;
          6'h2b: rem_table = 3'd2;
          6'h2c: rem_table = 3'd1;
          6'h2e: rem_table = 3'd5;
          6'h2f: rem_table = 3'd5;
          6'h34: rem_table = 3'd2;
          6'h35: rem_table = 3'd1;
          6'h37: rem_table = 3'd6;
          6'h3a: rem_table = 3'd1;
          6'h3b: rem_table = 3'd1;
          6'h3c: rem_table = 3'd3;
          6'h3d: rem_table = 3'd2;
          6'h3e: rem_table = 3'd1;
            default: rem_table = 3'd0;
          endcase
        end
        5'd1: begin
          case (sig_key)
          6'h0b: rem_table = 3'd2;
          6'h0c: rem_table = 3'd2;
          6'h0d: rem_table = 3'd2;
          6'h0e: rem_table = 3'd2;
          6'h0f: rem_table = 3'd2;
          6'h13: rem_table = 3'd1;
          6'h15: rem_table = 3'd4;
          6'h16: rem_table = 3'd4;
          6'h17: rem_table = 3'd4;
          6'h1c: rem_table = 3'd2;
          6'h1d: rem_table = 3'd1;
          6'h1f: rem_table = 3'd6;
          6'h23: rem_table = 3'd2;
          6'h25: rem_table = 3'd3;
          6'h26: rem_table = 3'd2;
          6'h27: rem_table = 3'd1;
          6'h2b: rem_table = 3'd1;
          6'h2c: rem_table = 3'd2;
          6'h2e: rem_table = 3'd4;
          6'h2f: rem_table = 3'd3;
          6'h35: rem_table = 3'd2;
          6'h37: rem_table = 3'd5;
          6'h3b: rem_table = 3'd2;
          6'h3c: rem_table = 3'd2;
          6'h3d: rem_table = 3'd4;
          6'h3e: rem_table = 3'd2;
            default: rem_table = 3'd0;
          endcase
        end
        5'd2: begin
          case (sig_key)
          6'h0b: rem_table = 3'd1;
          6'h0d: rem_table = 3'd4;
          6'h0e: rem_table = 3'd4;
          6'h0f: rem_table = 3'd4;
          6'h13: rem_table = 3'd2;
          6'h15: rem_table = 3'd3;
          6'h16: rem_table = 3'd2;
          6'h17: rem_table = 3'd1;
          6'h1d: rem_table = 3'd2;
          6'h1f: rem_table = 3'd5;
          6'h23: rem_table = 3'd1;
          6'h25: rem_table = 3'd1;
          6'h26: rem_table = 3'd4;
          6'h27: rem_table = 3'd2;
          6'h2b: rem_table = 3'd2;
          6'h2e: rem_table = 3'd2;
          6'h2f: rem_table = 3'd6;
          6'h35: rem_table = 3'd4;
          6'h37: rem_table = 3'd3;
          6'h3b: rem_table = 3'd1;
          6'h3d: rem_table = 3'd3;
          6'h3e: rem_table = 3'd4;
            default: rem_table = 3'd0;
          endcase
        end
        5'd3: begin
          case (sig_key)
          6'h0b: rem_table = 3'd2;
          6'h0d: rem_table = 3'd3;
          6'h0e: rem_table = 3'd2;
          6'h0f: rem_table = 3'd1;
          6'h13: rem_table = 3'd1;
          6'h15: rem_table = 3'd1;
          6'h16: rem_table = 3'd4;
          6'h17: rem_table = 3'd2;
          6'h1d: rem_table = 3'd4;
          6'h1f: rem_table = 3'd3;
          6'h23: rem_table = 3'd2;
          6'h25: rem_table = 3'd2;
          6'h26: rem_table = 3'd2;
          6'h27: rem_table = 3'd4;
          6'h2b: rem_table = 3'd1;
          6'h2e: rem_table = 3'd4;
          6'h2f: rem_table = 3'd5;
          6'h35: rem_table = 3'd3;
          6'h37: rem_table = 3'd6;
          6'h3b: rem_table = 3'd2;
          6'h3d: rem_table = 3'd1;
          6'h3e: rem_table = 3'd2;
            default: rem_table = 3'd0;
          endcase
        end
