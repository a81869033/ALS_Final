module ex247_semantic_div_bound_smallpat_nested_den_parallel(in, out);
  input [15:0] in;
  output [7:0] out;
  ...
  function [6:0] low_from_pat;
    ...
    input [1:0] step;
    begin
      (* parallel_case, full_case *) case ({pat, step})
  ...
  function [23:0] bound_attr;
    ...
    input [2:0] sig_d;
    begin
      (* parallel_case, full_case *) case (sig_d)
        3'd1: begin
          (* parallel_case, full_case *) case (sig_n)
