module ex202_bf16_exp10_sep_fields_e3_m3_s0_bits_14_15_bh4(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  always @* begin
    ...
    casez (sign_exp)
      ...
      9'b101110101: out_exp = 8'h7e;
      9'b10111011?: out_exp = 8'h7e;
      9'b1011110??: out_exp = 8'h7e;
      9'b101111100: out_exp = 8'h7e;
      9'b010000101: out_exp = 8'hff;
  ...
  always @* begin
    out_mant = 7'h00;
    casez (sign_exp)
      9'b001110110: out_mant = 7'h01;
      9'b101110101: out_mant = 7'h7f;
      9'h075: begin
        case (mant_hi3)
          3'h0: begin
            out_mant = 7'h00;
