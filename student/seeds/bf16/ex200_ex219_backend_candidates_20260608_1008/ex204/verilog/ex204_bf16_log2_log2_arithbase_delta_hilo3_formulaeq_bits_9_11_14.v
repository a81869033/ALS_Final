module ex204_bf16_log2_log2_arithbase_delta_hilo3_formulaeq_bits_9_11_14(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  wire bit_9 = in[15] | ((in[14:7] < 8'd95) | (in[14:7] == 8'd128) | (in[14:7] > 8'd158)) | ((in[14:7] == 8'd95) & (mant <= 7'd5)) | ((in[14:7] == 8'd125) & (mant != 7'd0)) | ((in[14:7] == 8'd126) & ((mant <= 7'd106) | (mant == 7'd127))) | ((in[14:7] == 8'd127) & (mant >= 7'd12)) | ((in[14:7] == 8'd158) & (mant >= 7'd118));
  wire bit_11 = in[15] | (in[14:7] == 8'd0) | (in[14:7] == 8'd126) | (in[14:7] == 8'd128) | (in[14:7] == 8'hff) | (((in[14:7] == 8'd125) | (in[14:7] == 8'd127)) & (mant != 7'd0));
  wire bit_14 = ~((~in[15]) & (((in[14:7] == 8'd126) | (in[14:7] == 8'd127) | (in[14:7] == 8'd128)) | ((in[14:7] == 8'd125) & (mant != 7'd0))));
