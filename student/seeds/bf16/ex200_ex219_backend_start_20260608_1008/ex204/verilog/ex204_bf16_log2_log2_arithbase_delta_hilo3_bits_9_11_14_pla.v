module ex204_bf16_log2_log2_arithbase_delta_hilo3_bits_9_11_14_pla(in, out);
  input [15:0] in;
  output [15:0] out;
  ...
  always @* begin
    ...
    casez (sign_exp)
      9'b00110????: bit_9 = 1'b0;
      9'b001110???: bit_9 = 1'b0;
      9'b0011110??: bit_9 = 1'b0;
      9'b001111100: bit_9 = 1'b0;
      9'b010000001: bit_9 = 1'b0;
      9'b01000001?: bit_9 = 1'b0;
      9'b0100001??: bit_9 = 1'b0;
      9'b010001???: bit_9 = 1'b0;
      9'b010010???: bit_9 = 1'b0;
      9'b0100110??: bit_9 = 1'b0;
      9'b01001110?: bit_9 = 1'b0;
        9'h05f: begin
          bit_9 = 1'b0;
          casez (mant)
            7'b00000??: bit_9 = 1'b1;
            7'b0000?0?: bit_9 = 1'b1;
            default: begin end
          endcase
        end
        9'h07d: begin
        ...
        9'h07e: begin
          ...
          casez (mant)
            7'b111?0??: bit_9 = 1'b0;
            7'b1110???: bit_9 = 1'b0;
            7'b11?11?0: bit_9 = 1'b0;
            7'b11?110?: bit_9 = 1'b0;
            7'b1101?11: bit_9 = 1'b0;
            default: begin end
          endcase
        end
        9'h07f: begin
  ...
  always @* begin
    bit_11 = 1'b1;
    casez (sign_exp)
      9'b000000001: bit_11 = 1'b0;
      9'b00000001?: bit_11 = 1'b0;
      9'b0000001??: bit_11 = 1'b0;
      9'b000001???: bit_11 = 1'b0;
      9'b00001????: bit_11 = 1'b0;
      9'b0001?????: bit_11 = 1'b0;
      9'b0010?????: bit_11 = 1'b0;
      9'b00110????: bit_11 = 1'b0;
      9'b001110???: bit_11 = 1'b0;
      9'b0011110??: bit_11 = 1'b0;
      9'b001111100: bit_11 = 1'b0;
      9'b010000001: bit_11 = 1'b0;
      9'b01000001?: bit_11 = 1'b0;
      9'b0100001??: bit_11 = 1'b0;
      9'b010001???: bit_11 = 1'b0;
      9'b01001????: bit_11 = 1'b0;
      9'b0101?????: bit_11 = 1'b0;
      9'b0110?????: bit_11 = 1'b0;
      9'b01110????: bit_11 = 1'b0;
      9'b011110???: bit_11 = 1'b0;
      9'b0111110??: bit_11 = 1'b0;
      9'b01111110?: bit_11 = 1'b0;
      9'b011111110: bit_11 = 1'b0;
        9'h07d: begin
          bit_11 = 1'b1;
          casez (mant)
            7'b0000000: bit_11 = 1'b0;
            default: begin end
          endcase
        end
        9'h07f: begin
  ...
  assign out = {(sign ? pair[31] : pair[15]), bit_14, (sign ? pair[29] : pair[13]), (sign ? pair[28] : pair[12]), bit_11, (sign ? pair[26] : pair[10]), bit_9, (sign ? pair[24] : pair[8]), (sign ? pair[23] : pair[7]), (sign ? pair[22] : pair[6]), (sign ? pair[21] : pair[5]), (sign ? pair[20] : pair[4]), (sign ? pair[19] : pair[3]), (sign ? pair[18] : pair[2]), (sign ? pair[17] : pair[1]), (sign ? pair[16] : pair[0])};
endmodule
